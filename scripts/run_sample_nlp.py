...
def main():
    ...
    try:
        from src.preprocessing.sample_data import main as sample_main
        sample_main(sample_rate=1)
    ...
    try:
        from src.nlp_analysis.text_preprocessing import main as nlp_main
        nlp_main()
    except Exception as e:
