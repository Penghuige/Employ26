#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Deep analysis of round 2 dataset - per-task majority and RAG TopK metrics."""

import json
from collections import Counter, defaultdict

with open("data/project-4-at-2026-05-27-01-51-7cceb9ba.json", "r", encoding="utf-8") as f:
